...
#SBATCH --job-name=HJ_fw_1
#SBATCH --output=log.train_fcos3d_waymo_1.log
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
python tools/train.py configs/fcos3d/fcos3d_r101-caffe-dcn_fpn_head-gn_8xb2-1x_waymoD5-fov-mono3d_1.py --cfg-options load_from="global_weight_fcos3d.pth"

# Source file with path
src_file="work_dirs/fcos3d_r101-caffe-dcn_fpn_head-gn_8xb2-1x_waymoD5-fov-mono3d_1/epoch_5.pth"
