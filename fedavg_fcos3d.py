...
def main():
    ...
    # load checkpoints
    ckpt1 = torch.load('work_dirs/fcos3d_r101-caffe-dcn_fpn_head-gn_8xb2-1x_waymoD5-fov-mono3d_1/epoch_5.pth', map_location=map_location)
    ckpt2 = torch.load('work_dirs/fcos3d_r101-caffe-dcn_fpn_head-gn_8xb2-1x_waymoD5-fov-mono3d_2/epoch_5.pth', map_location=map_location)
    ckpt3 = torch.load('work_dirs/fcos3d_r101-caffe-dcn_fpn_head-gn_8xb2-1x_waymoD5-fov-mono3d_3/epoch_5.pth', map_location=map_location)
    ckpt4 = torch.load('work_dirs/fcos3d_r101-caffe-dcn_fpn_head-gn_8xb2-1x_waymoD5-fov-mono3d_4/epoch_5.pth', map_location=map_location)
    ...
    global_model = torch.load('work_dirs/fcos3d_r101-caffe-dcn_fpn_head-gn_8xb2-1x_waymoD5-fov-mono3d_1/epoch_5.pth')
    ...
    torch.save(global_model, 'global_weight_fcos3d.pth')
