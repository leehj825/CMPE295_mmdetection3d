...
#SBATCH --job-name=HJ_pw3
#SBATCH --output=log.train_pgd_waymo_n3.log
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
python tools/train.py configs/pgd/pgd_r101-caffe_fpn_head-gn_4xb3-4x_waymoD5-fov-mono3d_n3.py --cfg-options load_from="global_weight_pgd.pth"

# Source file with path
src_file="work_dirs/pgd_r101-caffe_fpn_head-gn_4xb3-4x_waymoD5-fov-mono3d_n3/epoch_5.pth"
