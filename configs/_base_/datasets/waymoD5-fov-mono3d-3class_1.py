...
data_root = '/scratch/cmpe295-wu/hj/waymo_data/waymo_1_4_1/part_1/kitti_format/'
...
val_evaluator = dict(
    type='WaymoMetric',
    ann_file='/scratch/cmpe295-wu/hj/waymo_data/waymo_1_4_1/part_1/kitti_format/waymo_infos_val.pkl',
    waymo_bin_file='/scratch/cmpe295-wu/hj/waymo_data/waymo_1_4_1/fov_gt_all.bin',
    data_root='/scratch/cmpe295-wu/hj/waymo_data/waymo_1_4_1/part_1/waymo_format',
    metric='LET_mAP',
    load_type='fov_image_based',
    backend_args=backend_args)
