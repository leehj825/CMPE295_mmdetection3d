...
#SBATCH --job-name=HJ_fa
#SBATCH --output=log.fedavg.log
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
python fedavg_fcos3d.py configs/fcos3d/fcos3d_r101-caffe-dcn_fpn_head-gn_8xb2-1x_waymoD5-fov-mono3d_global.py


# Source file with path
src_file="global_weight_fcos3d.pth"
